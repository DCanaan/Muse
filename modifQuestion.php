...
$q=$bdd->query("SELECT * FROM faq WHERE id = '$idQuestion'");
    $ligne = $q-> fetch(); 
        ...
        if(count($messages) === 0)
            {
                    ...
                    $modif = $bdd->prepare("UPDATE faq SET question = :question, reponse = :reponse, categorie = :categorie WHERE id='$idQuestion'");
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="row">
                                    <div class="form-group">
                                        ...
                                        <textarea name="question" id="question" class="form-control input-md" placeholder="Question" tabindex="1"><?php echo($ligne['question']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Réponse</label>
                                        <textarea name="reponse" id="reponse" class="form-control input-md" placeholder="Descriptif de l'annonce" tabindex="2" rows="10"><?php echo($ligne['reponse']); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Catégorie (1 ou 2)</label>
                                        <input type="number" name="categorie" min="0" max="15" size="2" title="Only numbers are allowed" value="<?php echo($ligne['categorie']); ?>" tabindex="3"/>
                                    </div>
                            </div>
