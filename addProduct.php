        ...
        if(count($messages) === 0)
            {
                ...
                try
                {
                    $register = $bdd->prepare("INSERT INTO produits (titre, description, prix) VALUES (:titre, :description, :prix)");
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        ...
                        <div class="row">
                                <div class="form-group">
                                    <input type="text" name="titreAnnonce" id="titreAnnonce" class="form-control input-md" value="" placeholder="Titre" tabindex="1">
                                </div>
                                <div class="form-group">
                                    <textarea name="descriptifAnnonce" id="descriptifAnnonce" class="form-control input-md" value="" placeholder="Descriptif de l'annonce" tabindex="2" rows="10"></textarea>
                                </div>
                        </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <h3>Prix</h3>
                        <input type="number" name="prixEuros" min="0" max="9999" size="4" title="Only numbers are allowed" tabindex="3"/>
                        , 
                        <input type="number" name="prixCentimes" min="0" max="99" size="2" title="Only numbers are allowed" tabindex="4"/> €
                        <ul class="list-inline pull-right">
