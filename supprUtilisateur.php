...
$q=$bdd->prepare("DELETE FROM users WHERE id = '$idUtilisateur'");
$suppr = $q -> execute();
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Gestion des utilisateurs</h1>
                                        <h3>Utilisateur supprimée</h3>
                                        
                                        <div class="alert alert-success" role="alert" style="margin-top:20px;">
                                            L'utilisateur a été supprimée avec succès.
                                        </div>
                        <a href="gestionUtilisateurs.php"><p>Retourner à la gestion des utilisateurs</p></a>
